...
def main():
    ...
    cfg.policy_config.raw_action_log_path = "artifacts/molmospaces/molmoact2_yam_integration/official_sim_eval_bridge_act5_raw_actions.jsonl"
    cfg.policy_config.debug_dump_dir = (
        "artifacts/molmospaces/molmoact2_yam_integration/official_sim_eval_bridge_act5_debug"
    )
    ...
    try:
        ...
        report = {
            "execution_mode": cfg.policy_config.execution_mode,
            "evidence_level": "single /act chunk with <=5 selected actions executed for bounded diagnostic; not a long rollout",
        ...
        out = Path(
            "artifacts/molmospaces/molmoact2_yam_integration/official_sim_eval_bridge_act5_diagnostic_report.json"
        )
