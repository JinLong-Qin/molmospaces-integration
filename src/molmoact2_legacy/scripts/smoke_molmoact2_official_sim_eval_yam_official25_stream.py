...
CHUNK_SIZE = 5
OUT = Path(
    "artifacts/molmospaces/molmoact2_yam_integration/official_sim_eval_bridge_official25_stream_report.json"
)
...
def main():
    ...
    cfg.policy_config.raw_action_log_path = "artifacts/molmospaces/molmoact2_yam_integration/official_sim_eval_bridge_official25_stream_raw_actions.jsonl"
    cfg.policy_config.debug_dump_dir = "artifacts/molmospaces/molmoact2_yam_integration/official_sim_eval_bridge_official25_stream_debug"
    cfg.policy_config.debug_dump_max_calls = 2

    report = {
        "evidence_level": "official-smoothing streamed /act diagnostic: chunks of 5 actions, up to 25 selected actions, stops on first gripper-object contact/success, flushes after every action; closer to official launcher smoothing, not a long rollout",
        "endpoint_url": None,
