...
H5 = WORK / 'artifacts/seeds/raw' / seed_meta['raw_h5']
...
summary = {
    ...
    'saved_arrays': {
        ...
        'place_receptacle_pose_rel_observations': list(np.asarray(place_pose_rel_observations).shape),
...
log(f'saved datagen arrays: {out}')
try:
    task.close()
