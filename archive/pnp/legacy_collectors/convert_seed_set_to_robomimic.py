...
def main():
    ...
    ap.add_argument(
        "--out", type=Path, default=WORK / "artifacts/seeds/robomimic_pnp_10demo_aligned.hdf5"
    )
    args = ap.parse_args()
        ...
        data.attrs["env_args"] = json.dumps(
            {
                ...
                "type": 2,
                "note": "MolmoSpaces PnP synthetic planner expert source demos for MimicGen integration",
            }
        )
